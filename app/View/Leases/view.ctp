<div class="view">
    ...
    <table class ="tablesummary">
        ...
        <tr>
	        ...
	        <?php } ?>                          
            <td>
                 <?php echo $this->Html->image('payment-icon.png', array ('title' => 'Realizar Pago', 'url' =>
                    array ('controller' => 'Payments', 'action' => 'add', $lease['Lease']['id']),                    
                         ));
                 ?> 
                <?php echo $this->Html->image('edit-icon.png', array ('title' => 'Editar', 'url' =>
                    array ('controller' => 'Leases', 'action' => 'edit', $lease['Lease']['id'])
                         ));
                ?>          
                <?php echo $this->Html->image('printer-icon.png', array ('title' => 'Imprimir', 'url' =>
                    array ('controller' => 'Leases', 'action' => 'printContract', $lease['Lease']['id'])
                         ));
                ?> <span class="CloseContractImg">                                        
                 <?php echo $this->Html->image('delete-icon.png', array ('title' => 'Cerrar Contrato', 'url' =>
