<div class="edit">
    ...
    <table>
    	<tr>
            ...
            <?php echo $this->Form->input('local_type',
            		array ('label' => '', 'readonly' => 'readonly'));
            		//array ('label' => '', 'type'=>'select', 'options' => array('Vivienda','Comercial'),'default'=>'Apartment.local_type'));?> </td> 
